  ...
  const config = useMemo<WeddingConfig>(() => ({
    couple: {
      bride: {
        ...
        image: 'https://files.catbox.moe/ye1ccs.png',
      ...
      groom: {
        ...
        role: 'Mempelai Pria',
        image: 'https://files.catbox.moe/7c4cqd.png',
    ...
    music: {
      ...
      lyrics: [
        ...
        { time: 112, text: "I'll keep it safe, so don't you worry a thing" },
    ...
    hero: {
      backgroundImage: 'https://files.catbox.moe/444fud.jpg',
