    ...
    <div className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center text-white relative z-10">
        ...
        <div className="mb-12">
          ...
          <h2 className="text-4xl md:text-6xl font-serif mb-4 drop-shadow-lg">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6 max-w-5xl mx-auto mb-8">
          {Object.entries(timeLeft).map(([unit, value], index) => {
            ...
            return (
              ...
              >
                {/* Card Glow Effect */}
                <div className="absolute inset-0 bg-white/30 blur-xl rounded-3xl group-hover:bg-white/40 transition-all duration-300" />
                
                {/* Main Card */}
                <div className="relative bg-white/95 backdrop-blur-md rounded-3xl p-6 md:p-8 w-24 md:w-36 shadow-2xl border border-white/50 hover:scale-110 hover:rotate-3 transition-all duration-500">
                  {/* Decorative Corner */}
                  <div className="absolute top-2 right-2 w-3 h-3 bg-gradient-to-br from-rose-400 to-orange-400 rounded-full" />
                  
                  {/* Value */}
                  <div className={`text-5xl md:text-7xl font-bold mb-3 transition-all duration-300 ${
                    hasChanged ? 'animate-pulse text-rose-500' : 'text-gray-800'
                  }`}>
                  ...
                  <div className="relative">
                    <div className="text-xs md:text-sm uppercase tracking-wider font-semibold text-gray-600">
                      {unit}
                    </div>
                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-gradient-to-r from-rose-400 to-orange-400 rounded-full" />
                  </div>
                </div>

                {/* Hover Effect Ring */}
                <div className="absolute inset-0 rounded-3xl border-2 border-white/0 group-hover:border-white/50 transition-all duration-300 pointer-events-none" />
              </div>
            );
          })}
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-8">
          <div className="bg-white/20 backdrop-blur-sm rounded-full h-3 overflow-hidden border border-white/30">
            <div 
              className="h-full bg-gradient-to-r from-white via-amber-200 to-white animate-pulse"
              style={{ 
        ...
        {/* Footer Message */}
        <div className="relative">
          <div className="inline-block bg-white/90 backdrop-blur-md rounded-2xl px-8 py-4 shadow-2xl border border-white/50">
